...
function showAllDiv() {
	...
	getTexture = localStorage.getItem("textureZ") || '0.png';
...
$(document).keyup(function(event) { 
 if(event.which == 27) { 
  ...
  if(event.which == 8) { 
   ...
   document.getElementById('AccessDenied').style.display = "none";
      $("body").css("background-image", "url(../ASSETS/img/granted2.gif)");
   accessgranted.play();
   ...
   document.getElementById('AccessGranted').style.display = "none";
   	 document.getElementById('LevelRequired').style.display = "none";
   accessdenied.play();
   $("body").css("background-image", "url(../ASSETS/img/denied2.gif)");
 }
   ...
   $("body").css("background-image", "url(../ASSETS/textures/denied.gif)");
