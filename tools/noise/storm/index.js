...
var rainAudio = new Audio('storm/sound/thundershort.mp3');
...
function handleClick() {
  console.log('yes')
  if (rainAudio.paused) {
    corp.classList.add('anim');
    console.log('two')
    rainAudio.play();
    init();
    animloop();
	shower.removeEventListener('click', handleClick);
  } 
  
/*   else {
    corp.classList.toggle('anim');
    console.log('three')
    rainAudio.pause();
    rainthroughnum = 500;
    speedRainTrough = 25;
...
shower.addEventListener('click', handleClick);